module github.com/numtide/go2nix/torture/internal/conflict-a
...
require (
	...
	github.com/go-chi/chi/v5 v5.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/numtide/go2nix/torture/internal/common => ../common
