# default mode fixture test: xtest recompilation with local dependent packages.
#
...
if !(flake.packages.${system} ? go2nix-nix-plugin) then
  pkgs.runCommand "test-dag-fixture-xtest-local-dep-unsupported"
  ...
  pkgs.runCommand "test-dag-fixture-xtest-local-dep"
    ...
    ''
      ...
      echo "=== Building xtest-local-dep fixture (default mode, doCheck=true) ==="
