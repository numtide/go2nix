...
func unsafeString(b []byte) string {
	return *(*string)(unsafe.Pointer(&b)) //nolint:gosec // G103 - intentional unsafe string/byte conversion
}
...
func unsafeBytes(s string) []byte {
	return unsafe.Slice(unsafe.StringData(s), len(s)) //nolint:gosec // G103 - intentional unsafe string/byte conversion
}
